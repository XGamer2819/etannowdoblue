...
@Autonomous(name="redauto w/ farposition", group="Linear OpMode")
...
public class redautofar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            slideRotationMove("Up",3, 1);
            slideRotateStop();
           drive("Forward", 0.5, 1, 1, 1, 1);
           driveStop();
           drive("Left", 0.625, 1, 1, 1, 1 );
           driveStop();
           drive("TurnLeft", 0.61, 1, 1, 1, 1);
           drive("Forward", 0.25, 1, 1, 1, 1);
            driveStop();
           SlideMove("Extend", 1.75, 1);
           WheelIntake("Outake", 1.5);
           drive("Back", 0.1, 1, 1, 1, 1);
            IntakeStop();
            driveStop();
